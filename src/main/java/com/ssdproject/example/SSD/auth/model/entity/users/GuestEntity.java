...
public class GuestEntity extends UserEntity {
    ...
    @Builder
    public GuestEntity(@NotBlank @Size(max = 50) String name, @NotBlank @Size(max = 100) String surname, String url, String aboutMe, @NotBlank @Size(max = 50) @Email String email, @NotBlank @Size(min = 6, max = 100) String password, RoleEntity role, List<ConferenceEntity> conferences) {
